...
from PySide6.QtWidgets import (
    QApplication, QGraphicsOpacityEffect, QWidget, QVBoxLayout, QPushButton, QLabel, QTextEdit, QHBoxLayout, QStackedWidget, QTabWidget, QListWidget, QFileDialog, QMessageBox, QInputDialog, QListWidgetItem
)
...
if __name__ == "__main__":
    ...
    with Progress() as progress:
        ...
        while not progress.finished:
            for i in range(10):
                time.sleep(0.05)  # Simular un retraso
