...
app = "ServerAppBeta1Warn.py"

# Lista de archivos y directorios a verificar
files_to_check = [
    "AppReset.py", "AppStartup.py", "ServerAppBeta1Warn.py",  "icons/app.png",
...
def main():
    ...
    if missing_files:
        ...
        console.print("[bold green]Script ejecutado. Cerrando Python definitivamente...[/bold green]")
